...
def main() -> None:
    ...
    summary = {
        ...
        "aggregate": {
            "test_accuracy_mean": _mean([row["test_accuracy"] for row in per_seed_results]),
            "test_accuracy_std": _std([row["test_accuracy"] for row in per_seed_results]),
            "test_macro_f1_mean": _mean([row["test_macro_f1"] for row in per_seed_results]),
            "test_macro_f1_std": _std([row["test_macro_f1"] for row in per_seed_results]),
            "num_test_samples": per_seed_results[0]["num_test_samples"] if per_seed_results else 0,
        },
    }
